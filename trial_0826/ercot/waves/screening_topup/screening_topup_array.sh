#!/bin/bash
#$ -N screening_topup_array
#$ -q long
#$ -cwd
#$ -t 1-7
#$ -pe smp 4

# ERCOT screening TOP-UP array (prompt 26 T4, curtailment arm — see
# make_screening_topup.py). Submit from INSIDE the wave dir of the CRC
# ERCOT WORKTREE ($GROUP/ylu28/RTS-GMLC-ercot):
#   cd <worktree>/trial_0826/ercot/waves/screening_topup && qsub screening_topup_array.sh
